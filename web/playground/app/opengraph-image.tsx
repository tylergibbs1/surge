  ...
  return new ImageResponse(
    ...
    >
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        >
          A public next-24-hour load outlook for seven major US power
          markets—with explicit current, delayed, stale, and unavailable states.
        </p>
      </div>
      ...
      >
        ...
        <span style={{ display: "flex", gap: 20 }}>
          <span>7 RTOs · timestamped forecasts</span>
